  ...
  return (
    <div className="flex flex-col items-center text-center">
      ...
      <motion.button
        ...
        onClick={onNext}
        className="tech-corners group relative inline-flex items-center justify-center gap-4 px-10 py-5 font-semibold text-sm uppercase tracking-widest text-white bg-surface border border-white/20 hover:bg-accent hover:border-accent hover:text-black transition-all active:scale-95"
      >
        Başlayalım
