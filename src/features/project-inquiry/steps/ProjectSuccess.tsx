...
export function ProjectSuccess({ inquiryId }: ProjectSuccessProps) {
  return (
    <motion.div 
    ...
    >
      ...
      {inquiryId && (
        <p className="text-sm font-mono tracking-widest text-white/50 mb-12 bg-white/5 px-4 py-2 rounded-sm border border-white/10">
          Referans: {inquiryId}
        </p>
      )}
