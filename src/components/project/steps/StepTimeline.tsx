...
import { ProjectInquiry, ProjectTimeline } from '../../../types/project';
import { PROJECT_TIMELINES } from '../../../config/projectFormConfig';
      ...
      >
        ...
        <div className="flex gap-4 mb-4">
          <button
            ...
            className={`px-6 py-3 text-sm tech-corners border transition-all ${!data.hasDeadline ? 'bg-accent border-accent text-white' : 'bg-surface border-white/10 text-text-secondary hover:text-white'}`}
          >
            Hayır
          </button>
          <button
